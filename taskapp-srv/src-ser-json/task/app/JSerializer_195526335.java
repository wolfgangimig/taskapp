...
public class JSerializer_195526335 extends JSerializer_Object {
	
	public final static BSerializer instance = new JSerializer_195526335();
	
	public JSerializer_195526335() {
		super(195526335);
	}
	
	public JSerializer_195526335(int typeId) {
		super(typeId);
	}
