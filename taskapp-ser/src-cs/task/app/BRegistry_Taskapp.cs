...
namespace task.app
{
	...
	public class BRegistry_Taskapp : BRegistry { 
		...
		private static BRegisteredSerializer[] serializers = new BRegisteredSerializer[] {
			...
			new BRegisteredSerializer(475933318, "task.app.BSerializer_475933318", task.app.BSerializer_475933318.instance),
			...
			new BRegisteredSerializer(2130815904, "task.app.BSerializer_2130815904", task.app.BSerializer_2130815904.instance),
		};
